 ...
 * @author Stephen Suen
 */
public class InternetToTag extends InternetAddressTag {

    /**
     * The constant name of this header field.
     */
    public static final String HEADER_NAME = "To";

    /**
     * Default constructor.
     */
    public InternetToTag() {
        super();
    ...
    public int doEndTag() throws JspException {
        ...
        if (parentTag == null || !(parentTag instanceof MessageTag)) {
            throw new JspException(MessageUtil.getMessage(
                    "internettotag_nesting_error", getName(), getValue()));
        }
