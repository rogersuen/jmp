...
/**
 * <code>InternetSubjectTag</code> implements tags that create and add
 * a "Subject" header field to the {@link javax.mail.Message} instance 
 * associated with our most immediate enclosing instance of a tag whose
 * implementaion class is a subclass of {@link MessageTag}.
 *
 * @author Stephen Suen
 */
public class InternetSubjectTag extends InternetTextHeaderTag {
     ...
     * because the name of this header field must always be "Subject".
     * @param name the new name
     */
    @Override
    public void setName(String name) {
        // no-op, always be "Subject"
    }
